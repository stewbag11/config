...
class InlineMenuFieldQualificationService {
    constructor() {
        ...
        this.inlineMenuTotpFeatureFlag = false;
        ...
        void Promise.all([
            ...
            this.inlineMenuFieldQualificationFlagSet = !!(fieldQualificationFlag === null || fieldQualificationFlag === void 0 ? void 0 : fieldQualificationFlag.result);
            this.inlineMenuTotpFeatureFlag = !!(totpFeatureFlag === null || totpFeatureFlag === void 0 ? void 0 : totpFeatureFlag.result);
...
;// ./src/autofill/deprecated/overlay/iframe-content/autofill-overlay-iframe.service.deprecated.ts
...
/* harmony default export */ var autofill_overlay_iframe_service_deprecated = (AutofillOverlayIframeService);

;// ./src/autofill/deprecated/overlay/iframe-content/autofill-overlay-iframe-element.deprecated.ts

class AutofillOverlayIframeElement {
    constructor(element, iframePath, portName, initStyles, iframeTitle, ariaAlert) {
        const shadow = element.attachShadow({ mode: "closed" });
        const autofillOverlayIframeService = new autofill_overlay_iframe_service_deprecated(iframePath, portName, shadow);
        autofillOverlayIframeService.initOverlayIframe(initStyles, iframeTitle, ariaAlert);
    }
}
/* harmony default export */ var autofill_overlay_iframe_element_deprecated = (AutofillOverlayIframeElement);

;// ./src/autofill/deprecated/overlay/iframe-content/autofill-overlay-button-iframe.deprecated.ts


class AutofillOverlayButtonIframe extends autofill_overlay_iframe_element_deprecated {
    constructor(element) {
...
/* harmony default export */ var autofill_overlay_button_iframe_deprecated = (AutofillOverlayButtonIframe);

;// ./src/autofill/deprecated/overlay/iframe-content/autofill-overlay-list-iframe.deprecated.ts


class AutofillOverlayListIframe extends autofill_overlay_iframe_element_deprecated {
    constructor(element) {
...
/* harmony default export */ var autofill_overlay_list_iframe_deprecated = (AutofillOverlayListIframe);

;// ./src/autofill/deprecated/services/autofill-overlay-content.service.deprecated.ts
var autofill_overlay_content_service_deprecated_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class LegacyAutofillOverlayContentService {
    constructor() {
         ...
         */
        this.triggerOverlayRepositionUpdates = () => autofill_overlay_content_service_deprecated_awaiter(this, void 0, void 0, function* () {
            var _a, _b;
    ...
    setupOverlayListeners(autofillFieldElement, autofillFieldData, pageDetails) {
        return autofill_overlay_content_service_deprecated_awaiter(this, void 0, void 0, function* () {
            yield this.setupAutofillOverlayListenerOnField(autofillFieldElement, autofillFieldData, pageDetails);
        });
    }
    blurMostRecentlyFocusedField(_isClosingInlineMenu) {
        return autofill_overlay_content_service_deprecated_awaiter(this, void 0, void 0, function* () {
     ...
     */
    setupAutofillOverlayListenerOnField(formFieldElement, autofillFieldData, pageDetails) {
        return autofill_overlay_content_service_deprecated_awaiter(this, void 0, void 0, function* () {
    ...
    isIgnoredField(autofillFieldData, pageDetails) {
        ...
        return !this.inlineMenuFieldQualificationService.isFieldForLoginForm(autofillFieldData, pageDetails);
    }
    /**
    ...
    createAutofillOverlayButton() {
        ...
        if (this.isFirefoxBrowser) {
            ...
            new autofill_overlay_button_iframe_deprecated(this.overlayButtonElement);
            return;
        }
        ...
        (_a = globalThis.customElements) === null || _a === void 0 ? void 0 : _a.define(customElementName, class extends HTMLElement {
            constructor() {
                super();
                new autofill_overlay_button_iframe_deprecated(this);
            }
        });
    ...
    createAutofillOverlayList() {
        ...
        if (this.isFirefoxBrowser) {
            ...
            new autofill_overlay_list_iframe_deprecated(this.overlayListElement);
            return;
        }
        const customElementName = this.generateRandomCustomElementName();
        (_a = globalThis.customElements) === null || _a === void 0 ? void 0 : _a.define(customElementName, class extends HTMLElement {
            constructor() {
                super();
                new autofill_overlay_list_iframe_deprecated(this);
            }
        });
...
/* harmony default export */ var autofill_overlay_content_service_deprecated = (LegacyAutofillOverlayContentService);
...
;// ./src/autofill/deprecated/content/autofill-init.deprecated.ts
var autofill_init_deprecated_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class LegacyAutofillInit {
    ...
    constructor(autofillOverlayContentService) {
        ...
        this.collectAutofillContentService = new CollectAutofillContentService(this.domElementVisibilityService, domQueryService, this.autofillOverlayContentService);
    ...
    collectPageDetails(message_1) {
        return autofill_init_deprecated_awaiter(this, arguments, void 0, function* (message, sendDetailsInResponse = false) {
     ...
     */
    fillForm(_a) {
        return autofill_init_deprecated_awaiter(this, arguments, void 0, function* ({ fillScript, pageDetailsUrl }) {
...
/* harmony default export */ var autofill_init_deprecated = (LegacyAutofillInit);
...
(function (windowContext) {
    if (!windowContext.bitwardenAutofillInit) {
        const autofillOverlayContentService = new autofill_overlay_content_service_deprecated();
        windowContext.bitwardenAutofillInit = new autofill_init_deprecated(autofillOverlayContentService);
