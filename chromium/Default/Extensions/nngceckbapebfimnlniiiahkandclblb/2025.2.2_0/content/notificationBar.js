...
;// ./src/autofill/content/notification-bar.ts
...
function loadNotificationBar() {
    return notification_bar_awaiter(this, void 0, void 0, function* () {
        ...
        const activeUserServerConfig = yield sendExtensionMessage("bgGetActiveUserServerConfig");
        const activeUserVault = (_a = activeUserServerConfig === null || activeUserServerConfig === void 0 ? void 0 : activeUserServerConfig.environment) === null || _a === void 0 ? void 0 : _a.vault;
        ...
        function openBar(type, barPage, notificationBarInitData) {
            return notification_bar_awaiter(this, void 0, void 0, function* () {
                ...
                const useComponentBar = yield sendExtensionMessage("notificationRefreshFlagValue");
                setupInitNotificationBarMessageListener(notificationBarInitData);
                const barPageUrl = chrome.runtime.getURL(barPage);
                function getIframeStyle(useComponentBar) {
                    return ((useComponentBar
                ...
                function getFrameStyle(useComponentBar) {
                    return ((useComponentBar
                        ? "height: calc(276px + 25px); width: 450px; right: 0;"
